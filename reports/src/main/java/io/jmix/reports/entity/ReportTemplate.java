...
import io.jmix.reports.app.GsonEntityBuilder;
...
public class ReportTemplate implements com.haulmont.yarg.structure.ReportTemplate {
    ...
    public TemplateTableDescription getTemplateTableDescription() {
        ...
        return new GsonEntityBuilder()
                .build(GsonEntityBuilder.SerializationPolicy.ignoreMetadata)
    ...
    public void setTemplateTableDescription(TemplateTableDescription description) {
        if (description != null && getReportOutputType() == ReportOutputType.TABLE) {
            byte[] template = new GsonEntityBuilder()
                    .build(GsonEntityBuilder.SerializationPolicy.ignoreMetadata)
                    .toJson(description)
